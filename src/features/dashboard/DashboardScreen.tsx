...
type DashboardTab = 'today' | 'metrics';
...
export function DashboardScreen() {
  ...
  return (
    <div className="flex flex-col gap-3 pb-20">
      <div className="flex flex-col px-1 pt-2 mb-4">
        <div className="flex items-center justify-between">
          <div className="flex flex-col">
            <h1 className="text-3xl font-black text-bark tracking-tight leading-none">
              {greeting}
            </h1>
          ...
          <div className="flex bg-cream border border-pebble rounded-xl p-1 gap-1">
            <button
              onClick={() => setTab('today')}
              className={`px-3 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-wider transition-all ${
                (tab as DashboardTab) === 'today' ? 'bg-sage text-white' : 'text-bark-light'
              }`}
            >
              Today
            </button>
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-wider transition-all ${
                (tab as DashboardTab) === 'metrics' ? 'bg-sage text-white' : 'text-bark-light'
              }`}
            >
              Metrics
            </button>
